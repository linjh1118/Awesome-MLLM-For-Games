...
args = nlp.Args.get_args(
        ...
        output_file='/workspace/linjh/github/learn/Awesome-MLLM-For-Games/tools/arxiv_tools/asset/update_0323/select_paper/paper_bench_query.jsonl',
...
def get_input(): 
    ...
    meta_jsonl_data = selected_df.to_dict(orient='records') 
    return meta_jsonl_data

meta_jsonl_data = get_input()
...
INPUT_COLS = ['title', 'summary', 'llm_summary_res']
...
waited_processed_data = meta_jsonl_data
save_jsonl_data = waited_processed_data
