...
[[Paper](http://arxiv.org/pdf/2502.19559v1)] [[TLDR/Notes](#stay-focused--problem-drift-in-multi-agent-debate)]

- [25/02] **Beyond Win Rates: A Clustering-Based Approach to Character Balance Analysis in Team-Based Games** 
[[Paper](http://arxiv.org/pdf/2502.01250v1)] [[TLDR/Notes](#beyond-win-rates--a-clustering-based-approach-to-character-balance-analysis-in-team-based-games)]

- [25/02] **Towards Automation of Cognitive Modeling using Large Language Models** 
[[Paper](http://arxiv.org/pdf/2502.00879v1)] [[TLDR/Notes](#towards-automation-of-cognitive-modeling-using-large-language-models)]

- [25/02] **Triangulating LLM Progress through Benchmarks, Games, and Cognitive Tests** 
[[Paper](http://arxiv.org/pdf/2502.14359v1)] [[TLDR/Notes](#triangulating-llm-progress-through-benchmarks--games--and-cognitive-tests)]

- [25/02] **Who's the MVP? A Game-Theoretic Evaluation Benchmark for Modular Attribution in LLM Agents** 
[[Paper](http://arxiv.org/pdf/2502.00510v2)] [[TLDR/Notes](#who-s-the-mvp--a-game-theoretic-evaluation-benchmark-for-modular-attribution-in-llm-agents)]

- [25/01] **RepoAudit: An Autonomous LLM-Agent for Repository-Level Code Auditing** 
[[Paper](http://arxiv.org/pdf/2501.18160v2)] [[TLDR/Notes](#repoaudit--an-autonomous-llm-agent-for-repository-level-code-auditing)]

- [25/01] **Solving Urban Network Security Games: Learning Platform, Benchmark, and Challenge for AI Research** 
[[Paper](http://arxiv.org/pdf/2501.17559v1)] [[TLDR/Notes](#solving-urban-network-security-games--learning-platform--benchmark--and-challenge-for-ai-research)]

- [24/12] **From Multimodal LLMs to Generalist Embodied Agents: Methods and Lessons** 
[[Paper](http://arxiv.org/pdf/2412.08442v1)] [[TLDR/Notes](#from-multimodal-llms-to-generalist-embodied-agents--methods-and-lessons)]

- [24/12] **How Different AI Chatbots Behave? Benchmarking Large Language Models in Behavioral Economics Games** 
[[Paper](http://arxiv.org/pdf/2412.12362v1)] [[TLDR/Notes](#how-different-ai-chatbots-behave--benchmarking-large-language-models-in-behavioral-economics-games)]

- [24/12] **AuctionNet: A Novel Benchmark for Decision-Making in Large-Scale Games** 
[[Paper](http://arxiv.org/pdf/2412.10798v2)] [[TLDR/Notes](#auctionnet--a-novel-benchmark-for-decision-making-in-large-scale-games)]

- [24/12] **From Code to Play: Benchmarking Program Search for Games Using Large Language Models** 
[[Paper](http://arxiv.org/pdf/2412.04057v1)] [[TLDR/Notes](#from-code-to-play--benchmarking-program-search-for-games-using-large-language-models)]

- [24/11] **Adapter-based Approaches to Knowledge-enhanced Language Models -- A Survey** 
[[Paper](http://arxiv.org/pdf/2411.16403v1)] [[TLDR/Notes](#adapter-based-approaches-to-knowledge-enhanced-language-models----a-survey)]

- [24/11] **BALROG: Benchmarking Agentic LLM and VLM Reasoning On Games** 
[[Paper](http://arxiv.org/pdf/2411.13543v1)] [[TLDR/Notes](#balrog--benchmarking-agentic-llm-and-vlm-reasoning-on-games)]
...
[[Paper](http://arxiv.org/pdf/2410.10479v1)] [[TLDR/Notes](#tmgbench--a-systematic-game-benchmark-for-evaluating-strategic-reasoning-abilities-of-llms)]

- [24/09] **SimulBench: Evaluating Language Models with Creative Simulation Tasks** 
[[Paper](http://arxiv.org/pdf/2409.07641v1)] [[TLDR/Notes](#simulbench--evaluating-language-models-with-creative-simulation-tasks)]

- [24/09] **Game4Loc: A UAV Geo-Localization Benchmark from Game Data** 
[[Paper](http://arxiv.org/pdf/2409.16925v2)] [[TLDR/Notes](#game4loc--a-uav-geo-localization-benchmark-from-game-data)]
...
[[Paper](http://arxiv.org/pdf/2409.10244v1)] [[TLDR/Notes](#es-kt-24--a-multimodal-knowledge-tracing-benchmark-dataset-with-educational-game-playing-video-and-synthetic-text-generation)]

- [24/08] **Optimus-1: Hybrid Multimodal Memory Empowered Agents Excel in Long-Horizon Tasks** 
[[Paper](http://arxiv.org/pdf/2408.03615v2)] [[TLDR/Notes](#optimus-1--hybrid-multimodal-memory-empowered-agents-excel-in-long-horizon-tasks)]
...
[[Paper](http://arxiv.org/pdf/2408.10556v2)] [[TLDR/Notes](#hokoff--real-game-dataset-from-honor-of-kings-and-its-offline-reinforcement-learning-benchmarks)]
...
[[Paper](http://arxiv.org/pdf/2407.04221v2)] [[TLDR/Notes](#autoverse--an-evolvable-game-language-for-learning-robust-embodied-agents)]

- [24/07] **Enhancing Agent Learning through World Dynamics Modeling** 
[[Paper](http://arxiv.org/pdf/2407.17695v2)] [[TLDR/Notes](#enhancing-agent-learning-through-world-dynamics-modeling)]

- [24/07] **Odyssey: Empowering Minecraft Agents with Open-World Skills** 
[[Paper](http://arxiv.org/pdf/2407.15325v2)] [[TLDR/Notes](#odyssey--empowering-minecraft-agents-with-open-world-skills)]

- [24/07] **A Benchmark Environment for Offline Reinforcement Learning in Racing Games** 
[[Paper](http://arxiv.org/pdf/2407.09415v1)] [[TLDR/Notes](#a-benchmark-environment-for-offline-reinforcement-learning-in-racing-games)]

- [24/07] **Evaluating Large Language Models with Grid-Based Game Competitions: An Extensible LLM Benchmark and Leaderboard** 
[[Paper](http://arxiv.org/pdf/2407.07796v2)] [[TLDR/Notes](#evaluating-large-language-models-with-grid-based-game-competitions--an-extensible-llm-benchmark-and-leaderboard)]

- [24/06] **Using Game Play to Investigate Multimodal and Conversational Grounding in Large Multimodal Models** 
[[Paper](http://arxiv.org/pdf/2406.14035v3)] [[TLDR/Notes](#using-game-play-to-investigate-multimodal-and-conversational-grounding-in-large-multimodal-models)]

- [24/06] **EmoLLM: Multimodal Emotional Understanding Meets Large Language Models** 
[[Paper](http://arxiv.org/pdf/2406.16442v2)] [[TLDR/Notes](#emollm--multimodal-emotional-understanding-meets-large-language-models)]

- [24/06] **World Models with Hints of Large Language Models for Goal Achieving** 
[[Paper](http://arxiv.org/pdf/2406.07381v1)] [[TLDR/Notes](#world-models-with-hints-of-large-language-models-for-goal-achieving)]

- [24/06] **MLVU: Benchmarking Multi-task Long Video Understanding** 
[[Paper](http://arxiv.org/pdf/2406.04264v3)] [[TLDR/Notes](#mlvu--benchmarking-multi-task-long-video-understanding)]
...
[[Paper](http://arxiv.org/pdf/2405.17402v1)] [[TLDR/Notes](#thread--thinking-deeper-with-recursive-spawning)]
...
[[Paper](http://arxiv.org/pdf/2404.10179v3)] [[TLDR/Notes](#scaling-instructable-agents-across-many-simulated-worlds)]
...
[[Paper](http://arxiv.org/pdf/2403.03186v3)] [[TLDR/Notes](#cradle--empowering-foundation-agents-towards-general-computer-control)]

- [24/03] **Embodied LLM Agents Learn to Cooperate in Organized Teams** 
[[Paper](http://arxiv.org/pdf/2403.12482v2)] [[TLDR/Notes](#embodied-llm-agents-learn-to-cooperate-in-organized-teams)]

- [24/03] **Can LLM-Augmented autonomous agents cooperate?, An evaluation of their cooperative capabilities through Melting Pot** 
[[Paper](http://arxiv.org/pdf/2403.11381v2)] [[TLDR/Notes](#can-llm-augmented-autonomous-agents-cooperate---an-evaluation-of-their-cooperative-capabilities-through-melting-pot)]

- [24/03] **EnvGen: Generating and Adapting Environments via LLMs for Training Embodied Agents**  
[[Paper](http://arxiv.org/pdf/2403.12014v2)] [[TLDR/Notes](#envgen--generating-and-adapting-environments-via-llms-for-training-embodied-agents)]

- [24/03] **MineDreamer: Learning to Follow Instructions via Chain-of-Imagination for Simulated-World Control** 
[[Paper](http://arxiv.org/pdf/2403.12037v2)] [[TLDR/Notes](#minedreamer--learning-to-follow-instructions-via-chain-of-imagination-for-simulated-world-control)]

- [24/03] **Hierarchical Auto-Organizing System for Open-Ended Multi-Agent Navigation**  
[[Paper](http://arxiv.org/pdf/2403.08282v2)] [[TLDR/Notes](#hierarchical-auto-organizing-system-for-open-ended-multi-agent-navigation)]

- [24/03] **SOTOPIA-$π$: Interactive Learning of Socially Intelligent Language Agents** 
[[Paper](http://arxiv.org/pdf/2403.08715v3)] [[TLDR/Notes](#sotopia-$π$--interactive-learning-of-socially-intelligent-language-agents)]

- [24/03] **Will GPT-4 Run DOOM?** 
[[Paper](http://arxiv.org/pdf/2403.05468v1)] [[TLDR/Notes](#will-gpt-4-run-doom-)]

- [24/03] **Playing NetHack with LLMs: Potential & Limitations as Zero-Shot Agents**  
[[Paper](http://arxiv.org/pdf/2403.00690v1)] [[TLDR/Notes](#playing-nethack-with-llms--potential-&-limitations-as-zero-shot-agents)]
...
[[Paper](http://arxiv.org/pdf/2403.14589v3)] [[TLDR/Notes](#react-meets-actre--when-language-agents-enjoy-training-data-autonomy)]

- [24/03] **Language Guided Exploration for RL Agents in Text Environments** 
[[Paper](http://arxiv.org/pdf/2403.03141v1)] [[TLDR/Notes](#language-guided-exploration-for-rl-agents-in-text-environments)]

- [24/02] **Predicting Outcomes in Video Games with Long Short Term Memory Networks** 
[[Paper](http://arxiv.org/pdf/2402.15923v1)] [[TLDR/Notes](#predicting-outcomes-in-video-games-with-long-short-term-memory-networks)]
...
[[Paper](http://arxiv.org/pdf/2402.17574v3)] [[TLDR/Notes](#agent-pro--learning-to-evolve-via-policy-level-reflection-and-optimization)]

- [24/02] **PCA-Bench: Evaluating Multimodal Large Language Models in Perception-Cognition-Action Chain**  
[[Paper](http://arxiv.org/pdf/2402.15527v1)] [[TLDR/Notes](#pca-bench--evaluating-multimodal-large-language-models-in-perception-cognition-action-chain)]
...
[[Paper](http://arxiv.org/pdf/2402.02330v2)] [[TLDR/Notes](#enhance-reasoning-for-large-language-models-in-the-game-werewolf)]
...
[[Paper](http://arxiv.org/pdf/2402.11651v2)] [[TLDR/Notes](#learning-from-failure--integrating-negative-examples-when-fine-tuning-large-language-models-as-agents)]

- [24/02] **GenCeption: Evaluate Vision LLMs with Unlabeled Unimodal Data** 
[[Paper](http://arxiv.org/pdf/2402.14973v4)] [[TLDR/Notes](#genception--evaluate-vision-llms-with-unlabeled-unimodal-data)]

- [24/02] **Simple Stochastic Stopping Games: A Generator and Benchmark Library** 
[[Paper](http://arxiv.org/pdf/2402.02571v1)] [[TLDR/Notes](#simple-stochastic-stopping-games--a-generator-and-benchmark-library)]
...
[[Paper](http://arxiv.org/pdf/2401.17749v1)] [[TLDR/Notes](#swarmbrain--embodied-agent-for-real-time-strategy-game-starcraft-ii-via-large-language-models)]
...
[[Paper](http://arxiv.org/pdf/2401.06781v1)] [[TLDR/Notes](#pokergpt--an-end-to-end-lightweight-solver-for-multi-player-texas-hold-em-via-large-language-model)]

- [24/01] **Building Open-Ended Embodied Agent via Language-Policy Bidirectional Adaptation** 
[[Paper](http://arxiv.org/pdf/2401.00006v3)] [[TLDR/Notes](#building-open-ended-embodied-agent-via-language-policy-bidirectional-adaptation)]

- [24/01] **True Knowledge Comes from Practice: Aligning LLMs with Embodied Environments via Reinforcement Learning** 
[[Paper](http://arxiv.org/pdf/2401.14151v2)] [[TLDR/Notes](#true-knowledge-comes-from-practice--aligning-llms-with-embodied-environments-via-reinforcement-learning)]

- [23/12] **Cooperation on the Fly: Exploring Language Agents for Ad Hoc Teamwork in the Avalon Game**  
[[Paper](http://arxiv.org/pdf/2312.17515v1)] [[TLDR/Notes](#cooperation-on-the-fly--exploring-language-agents-for-ad-hoc-teamwork-in-the-avalon-game)]

- [23/12] **LLM-Powered Hierarchical Language Agent for Real-time Human-AI Coordination**  
[[Paper](http://arxiv.org/pdf/2312.15224v2)] [[TLDR/Notes](#llm-powered-hierarchical-language-agent-for-real-time-human-ai-coordination)]

- [23/12] **Large Language Models Play StarCraft II: Benchmarks and A Chain of Summarization Approach**  
[[Paper](http://arxiv.org/pdf/2312.11865v3)] [[TLDR/Notes](#large-language-models-play-starcraft-ii--benchmarks-and-a-chain-of-summarization-approach)]

- [23/12] **Auto MC-Reward: Automated Dense Reward Design with Large Language Models for Minecraft**  
[[Paper](http://arxiv.org/pdf/2312.09238v2)] [[TLDR/Notes](#auto-mc-reward--automated-dense-reward-design-with-large-language-models-for-minecraft)]

- [23/12] **MP5: A Multi-modal Open-ended Embodied System in Minecraft via Active Perception** 
[[Paper](http://arxiv.org/pdf/2312.07472v4)] [[TLDR/Notes](#mp5--a-multi-modal-open-ended-embodied-system-in-minecraft-via-active-perception)]
...
[[Paper](http://arxiv.org/pdf/2312.02312v1)] [[TLDR/Notes](#visual-encoders-for-data-efficient-imitation-learning-in-modern-video-games)]

- [23/12] **Deciphering Digital Detectives: Understanding LLM Behaviors and Capabilities in Multi-Agent Mystery Games**  
[[Paper](http://arxiv.org/pdf/2312.00746v2)] [[TLDR/Notes](#deciphering-digital-detectives--understanding-llm-behaviors-and-capabilities-in-multi-agent-mystery-games)]

- [23/12] **Empowering Working Memory for Large Language Model Agents** 
[[Paper](http://arxiv.org/pdf/2312.17259v2)] [[TLDR/Notes](#empowering-working-memory-for-large-language-model-agents)]

- [23/12] **From Centralized to Self-Supervised: Pursuing Realistic Multi-Agent Reinforcement Learning** 
[[Paper](http://arxiv.org/pdf/2312.08662v1)] [[TLDR/Notes](#from-centralized-to-self-supervised--pursuing-realistic-multi-agent-reinforcement-learning)]

- [23/11] **Finding the Needle in a Haystack: Detecting Bug Occurrences in Gameplay Videos** 
[[Paper](http://arxiv.org/pdf/2311.10926v1)] [[TLDR/Notes](#finding-the-needle-in-a-haystack--detecting-bug-occurrences-in-gameplay-videos)]
...
[[Paper](http://arxiv.org/pdf/2311.15209v3)] [[TLDR/Notes](#see-and-think--embodied-agent-in-virtual-environment)]

- [23/11] **DesignGPT: Multi-Agent Collaboration in Design** 
[[Paper](http://arxiv.org/pdf/2311.11591v1)] [[TLDR/Notes](#designgpt--multi-agent-collaboration-in-design)]
...
[[Paper](http://arxiv.org/pdf/2311.05772v2)] [[TLDR/Notes](#adapt--as-needed-decomposition-and-planning-with-language-models)]

- [23/11] **Language Model-In-The-Loop: Data Optimal Approach to Learn-To-Recommend Actions in Text Games** 
[[Paper](http://arxiv.org/pdf/2311.07687v1)] [[TLDR/Notes](#language-model-in-the-loop--data-optimal-approach-to-learn-to-recommend-actions-in-text-games)]

- [23/11] **Application-level Benchmarking of Quantum Computers using Nonlocal Game Strategies** 
[[Paper](http://arxiv.org/pdf/2311.01363v4)] [[TLDR/Notes](#application-level-benchmarking-of-quantum-computers-using-nonlocal-game-strategies)]

- [23/10] **Leveraging Word Guessing Games to Assess the Intelligence of Large Language Models**  
[[Paper](http://arxiv.org/pdf/2310.20499v2)] [[TLDR/Notes](#leveraging-word-guessing-games-to-assess-the-intelligence-of-large-language-models)]

- [23/10] **Language Agents with Reinforcement Learning for Strategic Play in the Werewolf Game**  
[[Paper](http://arxiv.org/pdf/2310.18940v3)] [[TLDR/Notes](#language-agents-with-reinforcement-learning-for-strategic-play-in-the-werewolf-game)]
...
[[Paper](http://arxiv.org/pdf/2310.13255v2)] [[TLDR/Notes](#steve-eye--equipping-llm-based-embodied-agents-with-visual-perception-in-open-worlds)]

- [23/10] **SOTOPIA: Interactive Evaluation for Social Intelligence in Language Agents** 
[[Paper](http://arxiv.org/pdf/2310.11667v2)] [[TLDR/Notes](#sotopia--interactive-evaluation-for-social-intelligence-in-language-agents)]

- [23/10] **Character-LLM: A Trainable Agent for Role-Playing** 
[[Paper](http://arxiv.org/pdf/2310.10158v2)] [[TLDR/Notes](#character-llm--a-trainable-agent-for-role-playing)]

- [23/10] **LLaMA Rider: Spurring Large Language Models to Explore the Open World**  
[[Paper](http://arxiv.org/pdf/2310.08922v1)] [[TLDR/Notes](#llama-rider--spurring-large-language-models-to-explore-the-open-world)]

- [23/10] **GameGPT: Multi-agent Collaborative Framework for Game Development** 
[[Paper](http://arxiv.org/pdf/2310.08067v1)] [[TLDR/Notes](#gamegpt--multi-agent-collaborative-framework-for-game-development)]
...
[[Paper](http://arxiv.org/pdf/2310.08588v2)] [[TLDR/Notes](#octopus--embodied-vision-language-programmer-from-environmental-feedback)]
...
[[Paper](http://arxiv.org/pdf/2310.06500v1)] [[TLDR/Notes](#metaagents--simulating-interactions-of-human-behaviors-for-llm-based-task-oriented-coordination-via-collaborative-generative-agents)]
...
[[Paper](http://arxiv.org/pdf/2310.05036v3)] [[TLDR/Notes](#avalonbench--evaluating-llms-playing-the-game-of-avalon)]
...
[[Paper](http://arxiv.org/pdf/2310.02172v1)] [[TLDR/Notes](#lyfe-agents--generative-agents-for-low-cost-real-time-social-interactions)]

- [23/10] **SmartPlay: A Benchmark for LLMs as Intelligent Agents** 
[[Paper](http://arxiv.org/pdf/2310.01557v5)] [[TLDR/Notes](#smartplay--a-benchmark-for-llms-as-intelligent-agents)]

- [23/10] **Avalon's Game of Thoughts: Battle Against Deception through Recursive Contemplation**  
[[Paper](http://arxiv.org/pdf/2310.01320v3)] [[TLDR/Notes](#avalon-s-game-of-thoughts--battle-against-deception-through-recursive-contemplation)]

- [23/10] **RoleLLM: Benchmarking, Eliciting, and Enhancing Role-Playing Abilities of Large Language Models**  
[[Paper](http://arxiv.org/pdf/2310.00746v3)] [[TLDR/Notes](#rolellm--benchmarking--eliciting--and-enhancing-role-playing-abilities-of-large-language-models)]

- [23/10] **Motif: Intrinsic Motivation from Artificial Intelligence Feedback**  
[[Paper](http://arxiv.org/pdf/2310.00166v1)] [[TLDR/Notes](#motif--intrinsic-motivation-from-artificial-intelligence-feedback)]
...
[[Paper](http://arxiv.org/pdf/2310.12931v2)] [[TLDR/Notes](#eureka--human-level-reward-design-via-coding-large-language-models)]

- [23/10] **Is ChatGPT a game changer for geocoding -- a benchmark for geocoding address parsing techniques** 
[[Paper](http://arxiv.org/pdf/2310.14360v4)] [[TLDR/Notes](#is-chatgpt-a-game-changer-for-geocoding----a-benchmark-for-geocoding-address-parsing-techniques)]

- [23/09] **AdaRefiner: Refining Decisions of Language Models with Adaptive Feedback**  
[[Paper](http://arxiv.org/pdf/2309.17176v3)] [[TLDR/Notes](#adarefiner--refining-decisions-of-language-models-with-adaptive-feedback)]

- [23/09] **Suspicion-Agent: Playing Imperfect Information Games with Theory of Mind Aware GPT-4**  
[[Paper](http://arxiv.org/pdf/2309.17277v3)] [[TLDR/Notes](#suspicion-agent--playing-imperfect-information-games-with-theory-of-mind-aware-gpt-4)]
...
[[Paper](http://arxiv.org/pdf/2309.09971v2)] [[TLDR/Notes](#mindagent--emergent-gaming-interaction)]
...
[[Paper](http://arxiv.org/pdf/2309.04658v2)] [[TLDR/Notes](#exploring-large-language-models-for-communication-games--an-empirical-study-on-werewolf)]

- [23/09] **Towards Ontology Construction with Language Models** 
[[Paper](http://arxiv.org/pdf/2309.09898v1)] [[TLDR/Notes](#towards-ontology-construction-with-language-models)]

- [23/09] **An Appraisal-Based Chain-Of-Emotion Architecture for Affective Language Model Game Agents** 
[[Paper](http://arxiv.org/pdf/2309.05076v1)] [[TLDR/Notes](#an-appraisal-based-chain-of-emotion-architecture-for-affective-language-model-game-agents)]

- [23/08] **Are ChatGPT and GPT-4 Good Poker Players? -- A Pre-Flop Analysis**  
[[Paper](http://arxiv.org/pdf/2308.12466v2)] [[TLDR/Notes](#are-chatgpt-and-gpt-4-good-poker-players-----a-pre-flop-analysis)]
...
[[Paper](http://arxiv.org/pdf/2308.08155v2)] [[TLDR/Notes](#autogen--enabling-next-gen-llm-applications-via-multi-agent-conversation)]

- [23/08] **CALYPSO: LLMs as Dungeon Masters' Assistants**  
[[Paper](http://arxiv.org/pdf/2308.07540v1)] [[TLDR/Notes](#calypso--llms-as-dungeon-masters--assistants)]
...
[[Paper](http://arxiv.org/pdf/2307.11922v1)] [[TLDR/Notes](#selective-perception--optimizing-state-descriptions-with-reinforcement-learning-for-language-model-actors)]
...
[[Paper](http://arxiv.org/pdf/2307.01848v1)] [[TLDR/Notes](#embodied-task-planning-with-large-language-models)]

- [23/07] **Challenges and Applications of Large Language Models** 
[[Paper](http://arxiv.org/pdf/2307.10169v1)] [[TLDR/Notes](#challenges-and-applications-of-large-language-models)]
...
[[Paper](http://arxiv.org/pdf/2306.00937v3)] [[TLDR/Notes](#steve-1--a-generative-model-for-text-to-behavior-in-minecraft)]
...
[[Paper](http://arxiv.org/pdf/2305.16867v1)] [[TLDR/Notes](#playing-repeated-games-with-large-language-models)]
...
[[Paper](http://arxiv.org/pdf/2305.15486v3)] [[TLDR/Notes](#spring--studying-the-paper-and-reasoning-to-play-games)]

- [23/05] **Improving Factuality and Reasoning in Language Models through Multiagent Debate** 
[[Paper](http://arxiv.org/pdf/2305.14325v1)] [[TLDR/Notes](#improving-factuality-and-reasoning-in-language-models-through-multiagent-debate)]

- [23/05] **Improving Language Model Negotiation with Self-Play and In-Context Learning from AI Feedback** 
[[Paper](http://arxiv.org/pdf/2305.10142v1)] [[TLDR/Notes](#improving-language-model-negotiation-with-self-play-and-in-context-learning-from-ai-feedback)]

- [23/05] **TidyBot: Personalized Robot Assistance with Large Language Models** 
[[Paper](http://arxiv.org/pdf/2305.05658v2)] [[TLDR/Notes](#tidybot--personalized-robot-assistance-with-large-language-models)]

- [23/05] **ArK: Augmented Reality with Knowledge Interactive Emergent Ability** 
[[Paper](http://arxiv.org/pdf/2305.00970v1)] [[TLDR/Notes](#ark--augmented-reality-with-knowledge-interactive-emergent-ability)]

- [23/05] **PersonaLLM: Investigating the Ability of Large Language Models to Express Personality Traits** 
[[Paper](http://arxiv.org/pdf/2305.02547v5)] [[TLDR/Notes](#personallm--investigating-the-ability-of-large-language-models-to-express-personality-traits)]

- [23/05] **SwiftSage: A Generative Agent with Fast and Slow Thinking for Complex Interactive Tasks** 
[[Paper](http://arxiv.org/pdf/2305.17390v2)] [[TLDR/Notes](#swiftsage--a-generative-agent-with-fast-and-slow-thinking-for-complex-interactive-tasks)]

- [23/05] **Language Models Meet World Models: Embodied Experiences Enhance Language Models** 
[[Paper](http://arxiv.org/pdf/2305.10626v3)] [[TLDR/Notes](#language-models-meet-world-models--embodied-experiences-enhance-language-models)]

- [23/05] **ToolkenGPT: Augmenting Frozen Language Models with Massive Tools via Tool Embeddings** 
[[Paper](http://arxiv.org/pdf/2305.11554v4)] [[TLDR/Notes](#toolkengpt--augmenting-frozen-language-models-with-massive-tools-via-tool-embeddings)]

- [23/04] **Generative Agents: Interactive Simulacra of Human Behavior**  
[[Paper](http://arxiv.org/pdf/2304.03442v2)] [[TLDR/Notes](#generative-agents--interactive-simulacra-of-human-behavior)]

- [23/04] **Can Large Language Models Play Text Games Well? Current State-of-the-Art and Open Questions**  
[[Paper](http://arxiv.org/pdf/2304.02868v1)] [[TLDR/Notes](#can-large-language-models-play-text-games-well--current-state-of-the-art-and-open-questions)]

- [23/04] **LaMP: When Large Language Models Meet Personalization** 
[[Paper](http://arxiv.org/pdf/2304.11406v4)] [[TLDR/Notes](#lamp--when-large-language-models-meet-personalization)]

- [23/04] **Dialogue Games for Benchmarking Language Understanding: Motivation, Taxonomy, Strategy** 
[[Paper](http://arxiv.org/pdf/2304.07007v1)] [[TLDR/Notes](#dialogue-games-for-benchmarking-language-understanding--motivation--taxonomy--strategy)]
...
[[Paper](http://arxiv.org/pdf/2303.03378v1)] [[TLDR/Notes](#palm-e--an-embodied-multimodal-language-model)]

- [23/03] **Self-Refine: Iterative Refinement with Self-Feedback** 
[[Paper](http://arxiv.org/pdf/2303.17651v2)] [[TLDR/Notes](#self-refine--iterative-refinement-with-self-feedback)]
...
[[Paper](http://arxiv.org/pdf/2303.00001v1)] [[TLDR/Notes](#reward-design-with-language-models)]

- [23/02] **Q-Cogni: An Integrated Causal Reinforcement Learning Framework**  
[[Paper](http://arxiv.org/pdf/2302.13240v1)] [[TLDR/Notes](#q-cogni--an-integrated-causal-reinforcement-learning-framework)]
...
[[Paper](http://arxiv.org/pdf/2302.02662v4)] [[TLDR/Notes](#grounding-large-language-models-in-interactive-environments-with-online-reinforcement-learning)]
...
[[Paper](http://arxiv.org/pdf/2301.12050v2)] [[TLDR/Notes](#do-embodied-agents-dream-of-pixelated-sheep--embodied-decision-making-using-language-guided-world-modelling)]

- [23/01] **Open-World Multi-Task Control Through Goal-Aware Representation Learning and Adaptive Horizon Prediction** 
[[Paper](http://arxiv.org/pdf/2301.10034v3)] [[TLDR/Notes](#open-world-multi-task-control-through-goal-aware-representation-learning-and-adaptive-horizon-prediction)]

- [22/12] **Equilibria in Repeated Games under No-Regret with Dynamic Benchmarks** 
[[Paper](http://arxiv.org/pdf/2212.03152v3)] [[TLDR/Notes](#equilibria-in-repeated-games-under-no-regret-with-dynamic-benchmarks)]

- [22/11] **Robotic Skill Acquisition via Instruction Augmentation with Vision-Language Models** 
[[Paper](http://arxiv.org/pdf/2211.11736v3)] [[TLDR/Notes](#robotic-skill-acquisition-via-instruction-augmentation-with-vision-language-models)]

- [22/10] **A Pilot Study on Teacher-Facing Real-Time Classroom Game Dashboards** 
[[Paper](http://arxiv.org/pdf/2210.09427v1)] [[TLDR/Notes](#a-pilot-study-on-teacher-facing-real-time-classroom-game-dashboards)]

- [22/10] **LEAGUE: Guided Skill Learning and Abstraction for Long-Horizon Manipulation** 
[[Paper](http://arxiv.org/pdf/2210.12631v2)] [[TLDR/Notes](#league--guided-skill-learning-and-abstraction-for-long-horizon-manipulation)]

- [22/10] **Emergent World Representations: Exploring a Sequence Model Trained on a Synthetic Task**  
[[Paper](http://arxiv.org/pdf/2210.13382v5)] [[TLDR/Notes](#emergent-world-representations--exploring-a-sequence-model-trained-on-a-synthetic-task)]
...
[[Paper](http://arxiv.org/pdf/2208.04024v1)] [[TLDR/Notes](#social-simulacra--creating-populated-prototypes-for-social-computing-systems)]

- [22/07] **Inner Monologue: Embodied Reasoning through Planning with Language Models** 
[[Paper](http://arxiv.org/pdf/2207.05608v1)] [[TLDR/Notes](#inner-monologue--embodied-reasoning-through-planning-with-language-models)]

- [22/07] **The Game of Hidden Rules: A New Kind of Benchmark Challenge for Machine Learning** 
[[Paper](http://arxiv.org/pdf/2207.10218v1)] [[TLDR/Notes](#the-game-of-hidden-rules--a-new-kind-of-benchmark-challenge-for-machine-learning)]
...
[[Paper](http://arxiv.org/pdf/2206.11795v1)] [[TLDR/Notes](#video-pretraining-(vpt)--learning-to-act-by-watching-unlabeled-online-videos)]
...
[[Paper](http://arxiv.org/pdf/2205.10416v1)] [[TLDR/Notes](#arlo--a-framework-for-automated-reinforcement-learning)]

- [22/03] **ScienceWorld: Is your Agent Smarter than a 5th Grader?** 
[[Paper](http://arxiv.org/pdf/2203.07540v2)] [[TLDR/Notes](#scienceworld--is-your-agent-smarter-than-a-5th-grader-)]

- [22/03] **FPGA-extended General Purpose Computer Architecture** 
[[Paper](http://arxiv.org/pdf/2203.10359v3)] [[TLDR/Notes](#fpga-extended-general-purpose-computer-architecture)]

- [22/03] **Enabling Multimodal Generation on CLIP via Vision-Language Knowledge Distillation** 
[[Paper](http://arxiv.org/pdf/2203.06386v2)] [[TLDR/Notes](#enabling-multimodal-generation-on-clip-via-vision-language-knowledge-distillation)]

- [22/01] **Multi-Stage Episodic Control for Strategic Exploration in Text Games** 
[[Paper](http://arxiv.org/pdf/2201.01251v3)] [[TLDR/Notes](#multi-stage-episodic-control-for-strategic-exploration-in-text-games)]
...
[[Paper](http://arxiv.org/pdf/2112.06963v2)] [[TLDR/Notes](#meterstick--benchmarking-performance-variability-in-cloud-and-self-hosted-minecraft-like-games-extended-technical-report)]

- [21/11] **Adaptive Multi-Goal Exploration** 
[[Paper](http://arxiv.org/pdf/2111.12045v2)] [[TLDR/Notes](#adaptive-multi-goal-exploration)]

- [21/09] **Benchmarking the Spectrum of Agent Capabilities** 
[[Paper](http://arxiv.org/pdf/2109.06780v2)] [[TLDR/Notes](#benchmarking-the-spectrum-of-agent-capabilities)]

- [21/08] **BEHAVIOR: Benchmark for Everyday Household Activities in Virtual, Interactive, and Ecological Environments** 
[[Paper](http://arxiv.org/pdf/2108.03332v1)] [[TLDR/Notes](#behavior--benchmark-for-everyday-household-activities-in-virtual--interactive--and-ecological-environments)]

- [21/07] **Pre-trained Language Models as Prior Knowledge for Playing Text-based Games** 
[[Paper](http://arxiv.org/pdf/2107.08408v2)] [[TLDR/Notes](#pre-trained-language-models-as-prior-knowledge-for-playing-text-based-games)]
...
[[Paper](http://arxiv.org/pdf/2103.14025v1)] [[TLDR/Notes](#the-threedworld-transport-challenge--a-visually-guided-task-and-motion-planning-benchmark-for-physically-realistic-embodied-ai)]

- [21/02] **Chess as a Testbed for Language Model State Tracking** 
[[Paper](http://arxiv.org/pdf/2102.13249v2)] [[TLDR/Notes](#chess-as-a-testbed-for-language-model-state-tracking)]
...
[[Paper](http://arxiv.org/pdf/2012.06168v4)] [[TLDR/Notes](#openholdem--a-benchmark-for-large-scale-imperfect-information-game-research)]

- [20/10] **ALFWorld: Aligning Text and Embodied Environments for Interactive Learning** 
[[Paper](http://arxiv.org/pdf/2010.03768v2)] [[TLDR/Notes](#alfworld--aligning-text-and-embodied-environments-for-interactive-learning)]
...
[[Paper](http://arxiv.org/pdf/2010.09890v2)] [[TLDR/Notes](#watch-and-help--a-challenge-for-social-perception-and-human-ai-collaboration)]

- [20/09] **A reinforcement learning approach to hybrid control design** 
[[Paper](http://arxiv.org/pdf/2009.00821v1)] [[TLDR/Notes](#a-reinforcement-learning-approach-to-hybrid-control-design)]

- [20/07] **Towards Game-Playing AI Benchmarks via Performance Reporting Standards** 
[[Paper](http://arxiv.org/pdf/2007.02742v1)] [[TLDR/Notes](#towards-game-playing-ai-benchmarks-via-performance-reporting-standards)]

- [20/05] **Interbank lending with benchmark rates: Pareto optima for a class of singular control games** 
[[Paper](http://arxiv.org/pdf/2005.05766v3)] [[TLDR/Notes](#interbank-lending-with-benchmark-rates--pareto-optima-for-a-class-of-singular-control-games)]

- [20/04] **Benchmarking End-to-End Behavioural Cloning on Video Games** 
[[Paper](http://arxiv.org/pdf/2004.00981v2)] [[TLDR/Notes](#benchmarking-end-to-end-behavioural-cloning-on-video-games)]

- [20/03] **Too many cooks: Bayesian inference for coordinating multi-agent collaboration** 
[[Paper](http://arxiv.org/pdf/2003.11778v2)] [[TLDR/Notes](#too-many-cooks--bayesian-inference-for-coordinating-multi-agent-collaboration)]

- [20/01] **Graph Constrained Reinforcement Learning for Natural Language Action Spaces** 
[[Paper](http://arxiv.org/pdf/2001.08837v1)] [[TLDR/Notes](#graph-constrained-reinforcement-learning-for-natural-language-action-spaces)]
...
[[Paper](http://arxiv.org/pdf/1910.13461v1)] [[TLDR/Notes](#bart--denoising-sequence-to-sequence-pre-training-for-natural-language-generation--translation--and-comprehension)]
...
[[Paper](http://arxiv.org/pdf/1910.07899v1)] [[TLDR/Notes](#design--benchmarking-and-explainability-analysis-of-a-game-theoretic-framework-towards-energy-efficiency-in-smart-infrastructure)]

- [19/09] **Interactive Fiction Games: A Colossal Adventure** 
[[Paper](http://arxiv.org/pdf/1909.05398v3)] [[TLDR/Notes](#interactive-fiction-games--a-colossal-adventure)]

- [19/08] **Quantum Poker A game for quantum computers suitable for benchmarking error mitigation techniques on NISQ devices** 
[[Paper](http://arxiv.org/pdf/1908.00044v4)] [[TLDR/Notes](#quantum-poker-a-game-for-quantum-computers-suitable-for-benchmarking-error-mitigation-techniques-on-nisq-devices)]

- [19/05] **Correlation in Extensive-Form Games: Saddle-Point Formulation and Benchmarks** 
[[Paper](http://arxiv.org/pdf/1905.12564v2)] [[TLDR/Notes](#correlation-in-extensive-form-games--saddle-point-formulation-and-benchmarks)]

- [19/04] **Habitat: A Platform for Embodied AI Research** 
[[Paper](http://arxiv.org/pdf/1904.01201v2)] [[TLDR/Notes](#habitat--a-platform-for-embodied-ai-research)]

- [19/04] **High-Level Representation of Benchmark Families for Petri Games** 
[[Paper](http://arxiv.org/pdf/1904.05621v1)] [[TLDR/Notes](#high-level-representation-of-benchmark-families-for-petri-games)]

- [19/03] **Leveling the Playing Field -- Fairness in AI Versus Human Game Benchmarks** 
[[Paper](http://arxiv.org/pdf/1903.07008v4)] [[TLDR/Notes](#leveling-the-playing-field----fairness-in-ai-versus-human-game-benchmarks)]

- [19/02] **Marathon Environments: Multi-Agent Continuous Control Benchmarks in a Modern Video Game Engine** 
[[Paper](http://arxiv.org/pdf/1902.09097v1)] [[TLDR/Notes](#marathon-environments--multi-agent-continuous-control-benchmarks-in-a-modern-video-game-engine)]

- [18/09] **Benchmarking Cognitive Abilities of the Brain with Computer Games** 
[[Paper](http://arxiv.org/pdf/1809.00172v1)] [[TLDR/Notes](#benchmarking-cognitive-abilities-of-the-brain-with-computer-games)]

- [18/08] **A Framework for Complementary Companion Character Behavior in Video Games** 
[[Paper](http://arxiv.org/pdf/1808.09079v1)] [[TLDR/Notes](#a-framework-for-complementary-companion-character-behavior-in-video-games)]

- [18/08] **The Text-Based Adventure AI Competition** 
[[Paper](http://arxiv.org/pdf/1808.01262v4)] [[TLDR/Notes](#the-text-based-adventure-ai-competition)]

- [18/06] **VirtualHome: Simulating Household Activities via Programs** 
[[Paper](http://arxiv.org/pdf/1806.07011v1)] [[TLDR/Notes](#virtualhome--simulating-household-activities-via-programs)]

- [18/06] **TextWorld: A Learning Environment for Text-based Games** 
[[Paper](http://arxiv.org/pdf/1806.11532v2)] [[TLDR/Notes](#textworld--a-learning-environment-for-text-based-games)]

- [18/06] **Counting to Explore and Generalize in Text-based Games** 
[[Paper](http://arxiv.org/pdf/1806.11525v2)] [[TLDR/Notes](#counting-to-explore-and-generalize-in-text-based-games)]
...
[[Paper](http://arxiv.org/pdf/1710.09599v2)] [[TLDR/Notes](#watch-your-step--learning-node-embeddings-via-graph-attention)]

- [17/07] **Proximal Policy Optimization Algorithms** 
[[Paper](http://arxiv.org/pdf/1707.06347v2)] [[TLDR/Notes](#proximal-policy-optimization-algorithms)]

- [17/05] **Text-based Adventures of the Golovin AI Agent** 
[[Paper](http://arxiv.org/pdf/1705.05637v1)] [[TLDR/Notes](#text-based-adventures-of-the-golovin-ai-agent)]

- [17/05] **Automatic Goal Generation for Reinforcement Learning Agents** 
[[Paper](http://arxiv.org/pdf/1705.06366v5)] [[TLDR/Notes](#automatic-goal-generation-for-reinforcement-learning-agents)]

- [17/01] **DeepStack: Expert-Level Artificial Intelligence in No-Limit Poker** 
[[Paper](http://arxiv.org/pdf/1701.01724v3)] [[TLDR/Notes](#deepstack--expert-level-artificial-intelligence-in-no-limit-poker)]

- [16/06] **Human-Agent Decision-making: Combining Theory and Practice** 
[[Paper](http://arxiv.org/pdf/1606.07514v1)] [[TLDR/Notes](#human-agent-decision-making--combining-theory-and-practice)]

- [15/08] **Word sense disambiguation: a survey** 
[[Paper](http://arxiv.org/pdf/1508.01346v1)] [[TLDR/Notes](#word-sense-disambiguation--a-survey)]

- [15/03] **Game-theoretic approach to risk-sensitive benchmarked asset management** 
[[Paper](http://arxiv.org/pdf/1503.01802v1)] [[TLDR/Notes](#game-theoretic-approach-to-risk-sensitive-benchmarked-asset-management)]

- [14/07] **Benchmarks for Parity Games (extended version)** 
[[Paper](http://arxiv.org/pdf/1407.3121v2)] [[TLDR/Notes](#benchmarks-for-parity-games-(extended-version))]

- [14/03] **Software Agents Interaction Algorithms in Virtual Learning Environment**  
[[Paper](http://arxiv.org/pdf/1403.5734v2)] [[TLDR/Notes](#software-agents-interaction-algorithms-in-virtual-learning-environment)]

- [14/03] **Face Recognition Methods & Applications** 
[[Paper](http://arxiv.org/pdf/1403.0485v1)] [[TLDR/Notes](#face-recognition-methods-&-applications)]

- [00/07] **Fate stochastic management and policy benchmark in 421, a popular game** 
[[Paper](http://arxiv.org/pdf/math/0007129v1)] [[TLDR/Notes](#fate-stochastic-management-and-policy-benchmark-in-421--a-popular-game)]
...
### 📌 背景痛点/本文动机
因果结构学习旨在从数据中推断因果模型。在生物学、医学、金融和机器学习等领域，因果模型都备受关注。因果模型不仅描述了变量的观测联合分布，还形式化了干预和反事实预测。有向无环图（DAG）是表示因果结构的常用方法，其中节点代表变量，有向边表示因果关系。然而，从观测数据中推断因果结构是困难的，通常只能识别DAG的马尔可夫等价类（MEC），并且找到高分的DAG是NP-hard问题。本文研究了线性加性噪声模型（ANM）的DAG学习问题。

### 🚀 核心方法
💡 创新点1：本文发现，对于通用采样的加性噪声模型，边际方差倾向于沿着因果顺序增加。为了衡量边际方差增加顺序与因果顺序之间的相关性，本文引入了“方差排序性”作为衡量指标。

💡 创新点2：本文发现，对于常见的采样图和模型参数，一些连续结构学习算法的出色性能可以通过高方差排序性来解释，并且可以通过一个简单的基线方法来匹配。然而，这种性能可能不会转移到现实世界的数据中，因为方差排序性可能适中或依赖于测量尺度的选择。

💡 创新点3：本文提出了一种名为“sortnregress”的简单基线方法，该方法通过按边际方差排序变量并使用稀疏回归技术选择父节点来工作。sortnregress的性能反映了给定设置中方差排序性的程度，并为结构学习算法提供了一个参考基线。

### 📈 实验结果
本文在合成数据上进行了实验，结果表明，一些算法在原始数据上表现良好，但在标准化数据上表现较差。sortnregress在原始数据上取得了有竞争力的性能，而在标准化数据上则表现出了基线性能。这表明，方差排序性在结构学习任务中起着重要作用。
...
### 🌟 论文解读 | 游戏AI性能评估：迈向标准化报告框架

### 📌 背景痛点/本文动机
游戏一直是评估游戏AI的重要里程碑，但缺乏标准化的报告框架，导致难以对不同的游戏AI算法进行公正比较。本文旨在提出一套报告指南，以促进不同AI方法之间的公平比较，并构建基于这些指南的基准测试和竞赛，从而更全面地了解不同AI算法的行为和不同游戏带来的挑战。

### 🚀 核心方法
💡 创新点1：提出游戏AI性能报告指南
本文提出了一个报告指南，旨在为游戏AI性能报告提供一个结构化的框架。该指南包括以下三个主要部分：
1. **问题描述**：详细描述测试问题的特征，包括任务类型、游戏内性能指标、游戏-AI交互方式和约束条件。
2. **解决方案复杂性描述**：描述AI解决方案的复杂性，包括硬件、操作系统、软件、计算复杂性、模型复杂性和实现复杂性。
3. **性能量化**：描述性能测量的方法，包括统计显著性评估、对手类型、测试案例的多样性和性能指标的聚合方式。

💡 创新点2：构建可解释的基准测试
本文提出了构建可解释基准测试的愿景，并提出了以下要求：
- 产生可测量的结果
- 允许得出有意义的结论
- 可解释性
- 产生可推广的结论
...
### 📈 实验结果
本文尚未进行实验，但提出了一个报告指南，旨在促进游戏AI性能评估的标准化和可解释性。
...
### 🌟 论文解读 | 基准利率下的银行间借贷：一类奇异控制博弈的帕累托最优解

### 📌 背景痛点/本文动机
银行间借贷市场是金融机构之间战略互动的有趣例子，参与者会根据其他参与者的行动分布做出反应。银行间基准利率的设定机制，如伦敦银行同业拆借利率（LIBOR），在金融市场中扮演着核心角色。然而，这种机制容易受到操纵，导致市场不稳定。本文旨在研究银行间借贷市场中，监管者如何通过干预来达到帕累托最优解，从而提高市场稳定性。

### 🚀 核心方法
💡 创新点1：本文构建了一个包含基准利率的银行间借贷动态模型，并将其转化为一个奇异控制博弈问题。
💡 创新点2：本文通过研究监管者的辅助控制问题，得到了帕累托最优解的刻画，并将其与Nash均衡进行了比较，揭示了监管干预对银行间利率稳定性的影响。
💡 创新点3：本文将帕累托最优解描述为一系列具有分段连续自由边界的Skorokhod问题，并通过求解这些问题得到了帕累托最优策略的显式表达式。

### 📈 实验结果
本文在N=2的情况下得到了帕累托最优策略的显式解，并与Nash均衡进行了比较。结果表明，帕累托最优策略能够有效降低银行间利率的波动性，提高市场稳定性。
...
framework.
### 🌟 论文解读 | 游戏化智能建筑：激励节能行为的新框架

### 📌 背景痛点/本文动机
随着全球能源消耗的持续增长，建筑能耗已成为一个重要的关注点。尽管智能建筑技术旨在提高能源效率，但人类行为的不确定性往往导致能源消耗的不可预测性。本文提出了一种基于博弈论的游戏化方法，旨在激励建筑使用者重新考虑个人能源使用，从而对环境产生积极影响。

### 🚀 核心方法
💡 创新点1：博弈论框架
本文引入了一个博弈论框架，将建筑使用者视为非合作博弈中的智能体。该框架通过创建一个界面，允许建筑管理者与使用者互动，并可能激励他们采取节能行为。与以往博弈论分析通常假设每个智能体的效用函数是预先已知的相比，本文提出了一种新颖的效用学习框架，用于基准测试，该框架采用对节能行为的 occupant 行动进行鲁棒估计。

💡 创新点2：深度双向循环神经网络
为了提高预测性能，本文扩展了效用学习方案，利用深度双向循环神经网络（RNN）。使用从 occupant 行动中收集的数据，例如房间照明，预测能源资源使用模式，以展示方法的预测性能。结果表明，可以实现 occupant 能源资源使用的高度准确表示。

💡 创新点3：可解释性分析
本文使用图形拉索和格兰杰因果算法，展示了数据集中固有的对人类决策制定的可解释性。这些算法揭示了不同特征之间的潜在条件依赖关系，以及特征之间的因果关系，从而加深了对人类能源使用决策制定的理解。

### 📈 实验结果
实验结果表明，本文提出的效用学习方法能够准确预测 occupant 的能源使用行为，并且深度双向 RNN 模型在预测性能方面优于其他模型。此外，可解释性分析揭示了不同能源效率行为类别中特征之间的相关性，以及特征之间的因果关系，从而加深了对人类能源使用决策制定的理解。
...
### 🌟 论文解读 | 量子扑克：在NISQ设备上测试错误缓解技术的游戏

### 📌 背景痛点/本文动机
量子计算机正逐渐成为商业现实，但它们的学习曲线陡峭，需要跨学科的知识。为了帮助初学者更容易地学习量子计算的基本规则，本文提出了一种名为“量子扑克”的游戏。该游戏旨在通过游戏化的方式教授量子状态、量子操作和测量的概念。

### 🚀 核心方法
💡 创新点1：量子扑克游戏
量子扑克游戏类似于德州扑克，但社区牌被量子寄存器取代，玩家手中的牌被量子门取代。每个玩家都可以使用他们的牌创建一个量子电路，目标是最大化在计算基中测量到的“1”的数量。游戏利用了叠加、纠缠和量子门的基本概念。

💡 创新点2：错误缓解技术
本文使用零噪声外推方法来缓解量子计算机上的错误。通过故意放大噪声并使用外推技术，可以更准确地估计可观测量在真实量子设备上的期望值。

### 📈 实验结果
实验结果表明，即使在简单的电路中，当代量子计算机的错误率仍然很高。使用错误缓解技术可以显著提高期望值的估计精度。
...
### 🌟 论文解读 | 深入理解扩展式游戏中的相关均衡：鞍点公式与基准测试

### 📌 背景痛点/本文动机
扩展式游戏（EFGs）是博弈论中的一种重要类型，它描述了玩家在一系列决策点上的交互过程。在扩展式游戏中，纳什均衡（NE）是一个被广泛研究的解概念，它假设每个玩家都是自私的，并试图最大化自己的收益。然而，纳什均衡可能无法达到社会最优，因为玩家的自私行为可能导致整体收益下降。为了解决这个问题，本文研究了扩展式相关均衡（EFCE）的概念，它允许一个外部设备（中介）向玩家提供推荐动作，但玩家可以自由选择是否遵循这些推荐。

### 🚀 核心方法
💡 创新点1：将EFCE问题转化为鞍点问题
本文的主要贡献之一是将EFCE问题转化为一个双线性鞍点问题（BSPP）。这种新的公式化方法为开发新的算法来计算EFCE提供了基础。为了展示这种新公式的潜力，本文提出了一种简单的子梯度下降方法，该方法利用了EFCE的公式和结构特性。与基于线性规划的先前方法相比，该方法具有更好的可扩展性。

💡 创新点2：提出两个基准游戏
为了评估EFCE求解器，本文提出了两个基准游戏：战舰游戏和警长游戏。这些游戏被设计为可参数化的，以便可以扩展到不同的大小。战舰游戏模拟了通过调解员进行冲突解决的场景，而警长游戏模拟了谈判和协商的场景。通过分析这些游戏中的EFCE，本文发现即使调解员无法强制执行行为，它也可以通过以下两种方式显著提高社会福利并阻止玩家偏离推荐：
1. 使用特定动作序列作为“密码”来验证玩家是否偏离：偏离会导致不完整或错误的密码，从而表明玩家已经偏离。
2. 如果检测到偏离，诱导对手对偏离推荐的玩家采取惩罚性行动。

### 📈 实验结果
本文通过实验验证了基于BSPP公式的子梯度下降方法在大型游戏实例中优于基于线性规划的先前方法。这表明BSPP公式在计算EFCE方面具有更好的可扩展性。
...
games.
### 🌟 论文解读 | 高级Petri游戏基准家族表示

### 📌 背景痛点/本文动机
Petri游戏作为一种多玩家游戏模型，被引入用于表示因果记忆，以解决分布式系统的综合问题。对于具有一个环境玩家和任意有界数量的系统玩家的Petri游戏，决定安全策略的存在性是EXPTIME完全的。这一结果构成了实现分布式控制器综合算法的工具ADAM的基础。为了评估该工具，它已在一系列来自制造和工作流程场景的参数化基准上进行测试。在本文中，我们引入了一种新的可能性，即用Petri游戏表示分布式综合问题的基准家族。它使用户能够将整个基准家族指定为一个参数化的高级网络。我们描述了作为Petri游戏高级版本的示例基准家族，并展示了产生具体1有界Petri游戏的实例化。通过检查高级Petri游戏，我们确定了基准家族在大小或功能方面的改进。

### 🚀 核心方法
💡 创新点1：高级Petri游戏表示
本文提出了基于高级Petri网的新参数化高级表示，用于简洁和清晰地定义基准家族。高级Petri网允许用户使用具有预定义参数大小的域中的单个令牌、具有条件标签的转换和具有表达式标签的弧来指定整个基准家族。

💡 创新点2：实例化技术
本文提出了一种实例化技术，可以将参数化高级Petri游戏转换为标准1有界Petri游戏。这使得现有的算法和工具可以解决这些Petri游戏。

### 📈 实验结果
本文通过两个示例基准家族（并发机器和自重构机器人）展示了高级Petri游戏表示的应用。与原始实现相比，这些基准家族在大小或功能方面得到了改进。
...
machines
### 🌟 论文解读 | 平台公平性：人工智能与人类游戏基准的公平性

### 📌 背景痛点/本文动机
自人工智能诞生以来，游戏一直是其研究和测试的平台。随着人工智能领域的发展，人类在复杂游戏中的水平成为了研究人员追求的目标。近年来，这一目标在传统桌面游戏如国际象棋、围棋等中得以实现。然而，随着研究的深入，电子游戏因其独特的挑战性而成为新的研究焦点。本文旨在探讨人工智能与人类在游戏基准测试中的公平性问题，并分析影响公平性的因素。

### 🚀 核心方法
本文首先回顾了人工智能在经典桌面游戏（如国际象棋、围棋）和现代电子游戏（如星际争霸、Dota 2）中的基准测试成果，并分析了这些成果在媒体和学术界的讨论。接着，本文提出了一个公平性维度分类法，用于评估人工智能与人类在游戏竞赛中的公平性。最后，本文论证了在游戏基准测试中，人工智能与人类之间不存在完全公平的比较方式。

### 📈 实验结果
本文通过分析人工智能在游戏基准测试中的表现，发现以下问题：
1. 人工智能在游戏中的表现往往被夸大或误解。
2. 人工智能与人类在游戏基准测试中的公平性存在争议。
3. 人工智能在游戏中的优势（如反应速度、信息获取等）可能被误解为不公平。
...
### 🌟 论文解读 | Marathon Environments：将深度强化学习应用于现代游戏引擎的持续控制基准

### 📌 背景痛点/本文动机
随着深度强化学习在持续控制领域的发展，游戏开发者对使用主动ragdoll的数字角色产生了兴趣。然而，目前开发这些想法的选项要么是研究人员有限的代码库，要么是专有的封闭系统。本文提出了Marathon Environments，这是一个开源的持续控制基准套件，在Unity游戏引擎上实现，使用Unity ML-Agents Toolkit。通过这些基准，本文展示了持续控制研究可以转移到商业游戏引擎，并展示了这些环境的鲁棒性。

### 🚀 核心方法
💡 创新点1：Marathon Environments是一个开源的持续控制基准套件，在Unity游戏引擎上实现，使用Unity ML-Agents Toolkit。这使得研究人员和开发者可以轻松地将持续控制研究应用于商业游戏引擎。

💡 创新点2：本文展示了Marathon Environments的鲁棒性，通过复制高级持续控制研究，例如从运动捕捉数据中学习行走、跑步和后空翻；学习导航复杂地形；以及实现视频游戏输入控制系统。此外，本文还展示了使用OpenAI.Baselines中的替代算法进行训练的鲁棒性。

### 📈 实验结果
本文通过实验验证了Marathon Environments的鲁棒性和有效性。实验结果表明，Marathon Environments可以成功复制高级持续控制研究，并展示了其在不同环境下的适应能力。此外，本文还分享了优化训练时间的策略，例如增加并发代理数量、使用无头模式、修改Academy脚本以支持物理步骤等。
...
### 🌟 论文解读 | 游戏理论视角下的风险敏感基准资产管理

### 📌 背景痛点/本文动机
在资产管理领域，投资者往往需要在追求投资回报和规避风险之间做出权衡。传统的风险敏感控制方法虽然能够在一定程度上平衡这两者，但在面对随机基准时，投资者的最优策略可能会受到影响。本文旨在通过引入游戏理论，构建一个风险敏感基准资产管理问题的游戏模型，以揭示投资者在面对市场对抗时的最优策略。

### 🚀 核心方法
💡 创新点1：构建风险敏感零和随机微分博弈模型
本文将风险敏感基准资产管理问题转化为一个零和随机微分博弈模型，其中投资者和市场分别作为两个玩家。投资者追求最大化其投资组合的预期增长率，而市场则试图通过调整随机基准来最小化投资者的预期回报。

💡 创新点2：求解最优策略
本文通过求解哈密顿-雅可比-贝尔曼偏微分方程，得到了投资者和市场在博弈中的最优策略。这些策略不仅考虑了投资者的风险厌恶程度，还考虑了市场对抗行为的影响。

### 📈 实验结果
本文通过数值模拟验证了所提出模型的有效性。结果表明，在风险敏感基准资产管理问题中，投资者和市场之间的博弈确实会影响投资者的最优策略。此外，本文还发现，投资者的风险厌恶程度和市场对抗行为的强度都会对最优策略产生影响。
...
### 🌟 论文解读 | 奠定公平博弈算法评估基石：全面解析公平博弈基准集

### 📌 背景痛点/本文动机
公平博弈在模型检验研究中扮演着重要角色，其求解问题被证明属于 NP ∩ co-NP 复杂度类，并且目前尚无已知的多项式时间算法。近年来，研究人员开发了大量的公平博弈求解算法，并研究了多项式时间化简技术。然而，由于缺乏标准基准集，难以对不同工具和算法进行比较评估。

### 🚀 核心方法
本文提出了一个全面的公平博弈基准集，旨在解决上述问题。该基准集包含以下特点：

* **多样性**：涵盖来自不同验证问题的游戏，包括模型检验、等价性检查、决策过程和合成问题。
* **代表性**：包含文献中已使用的所有基准游戏，并使用结构属性分析其代表性。
* **易用性**：所有游戏均以 PGSolver 格式在线提供，方便研究人员使用。

### 📈 实验结果
本文分析了基准集中游戏的多种结构属性，包括顶点数、边数、优先级数、度数、强连通分量、搜索策略特性、距离、局部结构和宽度度量等。结果表明，基准集涵盖了广泛的属性值，能够有效评估公平博弈算法的性能。

### 💬 可借鉴之处
* **构建标准基准集**：本文提出的基准集为公平博弈算法的评估提供了重要的参考，有助于推动该领域的研究进展。
* **分析结构属性**：本文对公平博弈的结构属性进行了深入分析，为算法设计和优化提供了新的思路。
* **探索新属性**：未来可以进一步探索公平博弈的其他结构属性，并研究其对算法性能的影响。
...
### 🌟 论文解读 | 421游戏中命运随机管理与策略基准

### 📌 背景痛点/本文动机
本文研究了法国流行的游戏421，这是一个具有完美信息的随机阶段游戏。游戏的目标是找到最大化某些预期效用概率的策略。作者将421游戏简化为玩家回合对抗命运的问题，这是一个命运随机管理问题。作者通过分析游戏规则和概率理论，提出了几种策略，并使用Kolmogorov方程精确评估了这些策略。

### 🚀 核心方法
💡 创新点1：将421游戏简化为玩家回合对抗命运的问题，这是一个命运随机管理问题。
💡 创新点2：提出了几种策略，包括伯努利策略和棘轮策略，并使用Kolmogorov方程精确评估了这些策略。
💡 创新点3：提出了目标识别编程方法，通过考虑结果概率来识别目标，从而简化策略的复杂性。

### 📈 实验结果
作者使用Mathematica软件实现了421游戏模型，并计算了各种策略的结果概率。实验结果表明，棘轮策略在D < F的情况下是最优的，而伯努利策略在D > F的情况下是最优的。此外，作者还发现，引入随机性和目标识别编程可以显著提高策略的效率。

### 💬 可借鉴之处
本文的研究结果对于理解随机游戏中的策略选择和命运管理具有重要意义。此外，本文提出的策略评估方法和目标识别编程方法也可以应用于其他随机决策问题。
